...
from app.handlers.common_menu.quick_tasks_handlers import quick_tasks_router
...
admin_menu_router.include_router(quick_tasks_router)
...
@admin_menu_router.callback_query(F.data == CALL_REVISION_MENU)
